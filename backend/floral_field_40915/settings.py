"""
Django settings for floral_field_40915 project.
...
ROOT_URLCONF = 'floral_field_40915.urls'
...
WSGI_APPLICATION = 'floral_field_40915.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_field_40915 API",
    "DESCRIPTION": "API documentation for floral_field_40915 App",
    "VERSION": "v1",
}
